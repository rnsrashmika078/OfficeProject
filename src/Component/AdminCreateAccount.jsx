...
function AdminCreateAccount({host}) {
    ...
    const handleResetClick = async (e) => {
        ...
        try {
            const response = await fetch(`${host}/AdminTables/save.php`, {
                method: 'POST',
                ...
                <p className="lead">Sign Up Page for Administration.</p></center>
                    ...
                    <div className="row mb-3">
                        ...
                        <div className="col-sm-9">
                            <input type="email" className="form-control" value={email} onChange={handleEmailChange} placeholder="Enter Admin Email" id="inputEmail3" required />
                        </div>
                    </div>
                    <div className="row mb-3">
                    ...
                    <div className="row mb-3">
                        ...
                        <div className="col-sm-9">
                            <input type="password" className="form-control"  value={adminCode} onChange={adminCodeChange} placeholder='Enter Admin Code Provided by the developer' id="inputPassword3"required />
                        </div>
                    </div>
