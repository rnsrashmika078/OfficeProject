...
const UserHardwareOther = () => {
  ...
  const handleAddEmptyRow = () => {
    const newRow = [null, 'new_01', 'new_01', 'new_01-01', 'new_01','new_01','new_01','new_01','new_01','new_01','new_01'];
  ...
  {data.length === 0 ? (
    ...
    filteredData
      .filter((row) => !selectedCategory || row[10] === selectedCategory || selectedCategory === 'ALL') // Filter rows by selected category
      .map((row, rowIndex) => (
        <tr
          key={rowIndex}
...
export default UserHardwareOther;
