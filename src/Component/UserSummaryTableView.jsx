...
useEffect(() => {
 ...
 useEffect(() => {
  ...
  <thead className="table-dark">
      ...
      {/* <h1>{servervalues.managerServerCount}</h1>
      <h1>{servervalues.engineerServerCount}</h1>
      <h1>{servervalues.accountSectionServerCount}</h1>
      <h1>{servervalues.commercialSectionServerCount}</h1>
      <h1>{servervalues.supplySectionServerCount}</h1>
      <h1>{servervalues.humanResourcesServerCount}</h1>
      <h1>{servervalues.sociologistServerCount}</h1>
      <h1>{servervalues.workshopServerCount}</h1>
      <h1>{servervalues.itBranchServerCount}</h1>
      <h1>{servervalues.receptionServerCount}</h1>
      <h1>{servervalues.oandMServerCount}</h1>
      <h1>{servervalues.auditBranchServerCount}</h1> */}
